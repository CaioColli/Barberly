...
export default function Welcome() {
    ...
    return (
        <section className='bg-background-primary min-h-screen h-full flex flex-col justify-between pt-[48px] px-[24px] lg:px-[32px]'>
            <Head title="Barberly">
                <link rel="preconnect" href="https://fonts.bunny.net" />
                <link href="https://fonts.bunny.net/css?family=instrument-sans:400,500,600" rel="stylesheet" />
            </Head>

            <span className='border-s-[5px] border-[#C99300] pl-[24px] text-5xl max-w-[200px] hidden lg:block lg:max-w-[350px] text-primary'>
            ...
            <main className='w-full flex justify-center items-center flex-col gap-[48px]'>
                <figure className='flex flex-col items-center gap-[24px]'>
                    ...
                    <img src="assets/barber_guy.png" alt="Foto do barbeiro" className='w-[200px] lg:w-[230px]'/>
                </figure>
                ...
                {auth.user ? (
                    ...
                    <div className='max-w-[350px] flex flex-col gap-[24px]'>
                        <h1 className='text-2xl font-azonix text-center text-primary'>
